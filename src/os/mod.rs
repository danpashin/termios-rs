...
#[cfg(any(target_os = "ios", target_os = "macos"))] pub use self::darwin as target;
...
#[cfg(any(target_os = "ios", target_os = "macos"))] pub mod darwin;
...
#[cfg(target_os = "macos")] pub use self::darwin as macos;
